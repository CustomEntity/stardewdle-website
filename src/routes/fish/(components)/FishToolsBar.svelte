    ...
    <StylizedModal>
        ...
        {#snippet content()}
            <div class="flex flex-col gap-5 text-left">
                <div>
                    <h2 class="font-bold text-lg text-white mb-2">{locale.t('pages.fish.modals.how_to_play_classic.introduction_title')}</h2>
                    <p class="text-gray-300">{locale.t('pages.fish.modals.how_to_play_classic.introduction_description')}</p>
                </div>

                <div>
                    <h2 class="font-bold text-lg text-white mb-2">{locale.t('pages.fish.modals.how_to_play_classic.attributes_title')}</h2>
                    <p class="text-gray-300 mb-2">{locale.t('pages.fish.modals.how_to_play_classic.attributes_description')}</p>
                ...
                <div>
                    <h2 class="font-bold text-lg text-white mb-2">{locale.t('pages.fish.modals.how_to_play_classic.feedback_title')}</h2>
                    <p class="text-gray-300 mb-2">{locale.t('pages.fish.modals.how_to_play_classic.feedback_description')}</p>
                    <ul class="list-none pl-0 text-gray-300">
                    ...
                    <p class="text-gray-300 mt-3 mb-2 font-semibold">{@html locale.t('pages.fish.modals.how_to_play_classic.feedback_arrows')}</p>
                    <ul class="list-none pl-0 text-gray-300">
                ...
                <div>
                    <h2 class="font-bold text-lg text-white mb-2">{locale.t('pages.fish.modals.how_to_play_classic.how_to_play_title')}</h2>
                ...
                <div>
                    <h2 class="font-bold text-lg text-white mb-2">{locale.t('pages.fish.modals.how_to_play_classic.strategy_title')}</h2>
                    <ul class="list-none pl-0 text-gray-300">
                ...
                <div>
                    <h2 class="font-bold text-lg text-white mb-2">{locale.t('pages.fish.modals.how_to_play_classic.daily_challenge_title')}</h2>
                    <p class="text-gray-300">{locale.t('pages.fish.modals.how_to_play_classic.daily_challenge_description')}</p>
                </div>
            </div>
        {/snippet}
    </StylizedModal>
