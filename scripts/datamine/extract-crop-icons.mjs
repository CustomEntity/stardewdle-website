// Extract each crop's 16x16 icon from its game sheet -> static/crops/<key>.png
...
const OUT = path.join(ROOT, 'static/crops');
fs.mkdirSync(OUT, { recursive: true });

const crops = JSON.parse(fs.readFileSync(path.join(__dirname, 'crops.json'), 'utf8'));
...
console.log(`✓ ${ok} crop icons -> static/crops/  (${skip} skipped)`);
