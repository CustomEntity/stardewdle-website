...
<ToolsBar>
    <StatsModal stats={gameData.stats}>
        {#snippet button(toggleModal)}
            <button
                ...
                <Tooltip text={locale.t('pages.crop.components.toolsBar.stats.tooltip')}>
                    <img src="/toolsbar/stats.png"
                         class="w-full h-full object-fit pixelated opacity-70 hover:opacity-100"
                         alt={locale.t('pages.crop.components.toolsBar.stats.alt')}/>
                </Tooltip>
            </button>
        {/snippet}
    </StatsModal>
    ...
    <button class="w-8 fill-[#C3C1C1] hover:fill-[#fff] duration-300 relative bottom-[3px]">
        <Tooltip
                maxWidth={150}
                text={locale.t('pages.crop.components.toolsBar.streak.tooltip')}>
            {#if streak > 0}
                <img src="/toolsbar/active_streak.gif"
                     class="w-full h-full object-fit"
                     alt={locale.t('pages.crop.components.toolsBar.streak.alt.active')}>
            {:else}
                <img src="/toolsbar/not_active_streak.png"
                     class="w-full h-full object-fit"
                     alt={locale.t('pages.crop.components.toolsBar.streak.alt.inactive')}>
            {/if}
            <span
    ...
    <PatchNotesModal patchNotes={patchNotes}>
        {#snippet button(toggleModal)}
            <button
                    onclick={toggleModal}
                    class="cursor-pointer size-[32px] hover:fill-[#fff] duration-300">
                <Tooltip text={locale.t('pages.crop.components.toolsBar.patchNotes.tooltip')}>
                    <img src="/toolsbar/changelog.png"
                         class="w-full h-full object-fit opacity-70 hover:opacity-100"
                         alt={locale.t('pages.crop.components.toolsBar.patchNotes.alt')}
                    />
                </Tooltip>
            </button>
        {/snippet}
    ...
    <StylizedModal>
        {#snippet trigger(toggleModal)}
            <button
                ...
                <Tooltip
                        maxWidth={150}
                        text={locale.t('pages.crop.components.toolsBar.howToPlay.tooltip')}>
                    <svg
        ...
        {/snippet}
        {#snippet title()}
            {locale.t('pages.crop.modals.how_to_play_classic.title')}
        {/snippet}
        {#snippet content()}
            <div class="flex flex-col gap-5 text-left">
                ...
                <div>
                    ...
                    <ul class="list-none pl-0 text-gray-300">
                        ...
                        <li class="mb-1">{@html locale.t('pages.crop.modals.how_to_play_classic.attribute_item_4')}</li>
                        <li class="mb-1">{@html locale.t('pages.crop.modals.how_to_play_classic.attribute_item_5')}</li>
                        <li class="mb-1">{@html locale.t('pages.crop.modals.how_to_play_classic.attribute_item_6')}</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ol class="list-decimal pl-5 text-gray-300">
                        ...
                        <li class="mb-1">{locale.t('pages.crop.modals.how_to_play_classic.step_4')}</li>
                        <li class="mb-1">{locale.t('pages.crop.modals.how_to_play_classic.step_5')}</li>
                        <li class="mb-1">{locale.t('pages.crop.modals.how_to_play_classic.step_6')}</li>
                        <li class="mb-1">{locale.t('pages.crop.modals.how_to_play_classic.step_7')}</li>
                    </ol>
                </div>
                ...
                <div>
                    ...
                    <ul class="list-none pl-0 text-gray-300">
                        ...
                        <li class="mb-1">{locale.t('pages.crop.modals.how_to_play_classic.strategy_tip_4')}</li>
                        <li class="mb-1">{locale.t('pages.crop.modals.how_to_play_classic.strategy_tip_5')}</li>
                        <li class="mb-1">{locale.t('pages.crop.modals.how_to_play_classic.strategy_tip_6')}</li>
                    </ul>
                </div>
